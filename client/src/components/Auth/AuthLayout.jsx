...
// Reusable Dharma-wheel mark, shared by the small brand lockup and the large
// decorative background motif on the hero panel.
...
export default function AuthLayout({ eyebrow, heroTitle, heroSubtitle, children }) {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-[#faf9f6]">
      ...
      <div className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-maroon-950 via-maroon-800 to-saffron-700 text-white flex-col justify-between p-12 xl:p-16">
        {/* Decorative oversized wheel + mandala rings */}
        <DharmaWheel className="absolute -right-24 -top-24 h-[28rem] w-[28rem] text-white/5 animate-[spin_90s_linear_infinite]" />
      ...
      <div className="flex flex-col min-h-screen px-6 py-8 sm:px-10 sm:py-10">
        ...
        <div className="flex items-center justify-between mb-8 lg:mb-12">
          <Link to="/" className="flex items-center gap-2 lg:hidden group">
            ...
            <span className="font-semibold text-base tracking-wide bg-gradient-to-r from-maroon-700 to-saffron-600 bg-clip-text text-transparent">

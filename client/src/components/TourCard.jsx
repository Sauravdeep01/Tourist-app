...
export default function TourCard({ tour }) {
  ...
  return (
    <div className="flex flex-col rounded-3xl overflow-hidden bg-[#161f30] text-white border border-slate-800 hover:border-saffron-400/50 shadow-xl transition-all duration-300">
      ...
      <div className="relative h-56 overflow-hidden bg-slate-900">
        ...
        <span className="absolute bottom-4 right-4 bg-slate-950/80 backdrop-blur-xs text-white text-xs font-semibold px-2.5 py-1 rounded-md flex items-center gap-1 border border-white/20">
      ...
      <div className="p-6 flex-grow flex flex-col justify-between">
        <div>
          ...
          {/* Subtitle / Route line */}
          <p className="text-sm font-semibold text-saffron-400 mb-3 line-clamp-1">
            {L(tour.subtitle, lang)}
          </p>

          {/* Overview text */}
          <p className="text-sm text-slate-300 mb-4 line-clamp-3 leading-relaxed font-sans">
        ...
        <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-bold text-saffron-400">
                {priceLabel}
              </p>
            </div>
            ...
            <Link
              to={`/tours/${tour.slug}`}
              className="inline-flex items-center justify-center gap-1.5 bg-saffron-500 hover:bg-saffron-600 text-neutral-950 font-bold text-xs px-4 py-2.5 rounded-xl transition-all shadow-xs group cursor-pointer"
            >
